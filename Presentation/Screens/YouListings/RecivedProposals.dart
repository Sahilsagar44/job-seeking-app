                            ...
                            onTap: () {
                              Get.to(
                                  ProposalDetails(
                                    ...
                                    skill1: snapshot.data!.docs[index]
                                        ["Skill1"],
                                    skill2: snapshot.data!.docs[index]
                                        ["Skill2"],
                                    skill3: snapshot.data!.docs[index]
                                        ["Skill3"],
                                  ),
                                            ...
                                            onPressed: () {
                                              Get.to(
                                                  ProposalDetails(
                                                    ...
                                                    Title: snapshot.data!
                                                        .docs[index]["Title"],
                                                    skill1: snapshot.data!
                                                        .docs[index]["Skill1"],
                                                    skill2: snapshot.data!
                                                        .docs[index]["Skill2"],
                                                    skill3: snapshot.data!
                                                        .docs[index]["Skill3"],
                                                  ),
                                                  duration: Duration(
                                                      milliseconds: 600),
